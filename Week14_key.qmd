...
__The null hypothesis would be that marginal probabilities (of Better) are the same for the placebo and treatment. The alternative would be that one of the interventions is more effective than the other. In this situation, there is not evidence to reject the null hypothesis.__
...
- (Intercept) would be `u[1] + alpha + gamma_1`
`r u[1] + alpha + gamma_1`
